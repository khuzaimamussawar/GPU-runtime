...
FlashVSR Block-Sparse-Attention Docker builds are specialized for the approved 24-48 GB SceneBuilder enhancer fleet. Do not compile the upstream broad `80;90;100;110;120` target set: sm90/Hopper, sm100/datacenter Blackwell and sm110/Thor are excluded by the provider allowlist and waste builder time/RAM. Patch the pinned Block-Sparse setup in Docker to emit native gencodes for `86;89;120`: sm86 covers approved Ampere, sm89 covers approved Ada and sm120 covers Blackwell RTX.
